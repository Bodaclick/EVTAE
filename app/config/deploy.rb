set :application, "EVTAE"
set :repository,  "git@github.com:Bodaclick/EVTAE.git"
set :scm,         :git
...
before "symfony:cache:warmup", "symfony:doctrine:schema:update", "symfony:doctrine:cache:clear_query"
